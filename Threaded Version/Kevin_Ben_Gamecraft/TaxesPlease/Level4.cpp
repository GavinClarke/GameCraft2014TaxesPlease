...
public:
	Level4(int count, b2World* w, SDL_Renderer* r)
	{
		m_platforms.push_back(new BasicPlatform(w,r,b2Vec2(0 ,800 - (count * CONSTANTS::LEVEL_HEIGHT)),0));
		m_fallingPlatforms.push_back(new FallingPlatform(w,r,b2Vec2(410, 540 - (count * CONSTANTS::LEVEL_HEIGHT)),0));
		m_fallingPlatforms.push_back(new FallingPlatform(w,r,b2Vec2(750, 380 - (count * CONSTANTS::LEVEL_HEIGHT)),0));
		m_fallingPlatforms.push_back(new FallingPlatform(w,r,b2Vec2(300, 100 - (count * CONSTANTS::LEVEL_HEIGHT)),0));
	}
